...
public class MyJavaNameSuggestionProvider implements NameSuggestionProvider {
    /**
     * Commented lines that add the initial name of the element to a result.
     */
    @SuppressWarnings("CommentedOutCode")
    @Override
    @Nullable
    public SuggestedNameInfo getSuggestedNames(final @NotNull PsiElement element, final PsiElement nameSuggestionContext, @NotNull Set<String> result) {
